...
let carInventory = require('./carLot'),
    ...
    carTemplate =require('../templates/car-grid.hbs'); //this is now a function
...
function populatePage (inventory) {
  ...
  inventory.forEach(function(car, index) {
    let carCard = document.getElementById("inventory-cards");//buildCard(car, index);
    let cardDiv = document.createElement("div"); 
    cardDiv.innerHTML = (carTemplate(inventory)); //here's the data we want passed);
